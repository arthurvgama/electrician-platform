...
--
-- One row per signed-in user, holding the same three JSON blobs that used to live in
-- localStorage (electrician_requests / electrician_settings / electrician_purchase).
