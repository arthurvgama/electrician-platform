...
// Azure, IBM watsonx) that block direct browser requests. Functionally the same
// forwarder as the old Cloudflare Worker in proxy-setup.html, just hosted on
// Supabase so every user of the app gets it automatically with no setup of
// their own.
//
